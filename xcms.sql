...
--
-- Host: localhost
-- Generation Time: Apr 09, 2012 at 05:04 PM
...
ALTER TABLE `blocksinfo`
  ...
  ADD CONSTRAINT `blocksinfo_ibfk_2` FOREIGN KEY (`CRID`) REFERENCES `users` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE;
